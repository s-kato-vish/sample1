    ...
    export default class Main extends AbpBase {
        ...
        get menuList () {
          return this.$store.state.app.menuList;
            // return [ { "path": "/setting", "name": "setting", "permission": "", "meta": { "title": "ManageMenu" }, "icon": "&#xe68a;", "children": [ { "path": "user", "permission": "Pages.Users", "meta": { "title": "Users" }, "name": "user" }, { "path": "role", "permission": "Pages.Roles", "meta": { "title": "Roles" }, "name": "role" } ] } ];
        }
        get pageTagsList () {
